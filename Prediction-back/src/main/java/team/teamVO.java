...
public class teamVO {
	...
	public teamVO(int rank,String club_name,double win,int score_s,int score_f){
		this.rank = rank;
	...
	public teamVO(String club_name,int score_s,int score_f){
		this.club_name = club_name;
		this.score_s = score_s;
		this.score_f = score_f;
	}
	public teamVO(String club_name,double win_rate,int rank){
		this.club_name = club_name;
